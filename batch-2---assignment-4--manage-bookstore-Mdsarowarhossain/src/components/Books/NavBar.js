...
import { setSearch } from '../../redux/Filter/Actions';
export default function NavBar() {
  ...
  const habdelchabde= (e)=>{
    usedispetch(setSearch(e.target.value));
  }
  return (
    ...
    <div className="container flex items-center justify-between">
      ...
      <form className="flex items-center" onSubmit={handelSubmit}>
        <div className="group relative rounded-md bg-white">
          ...
          <input type="text" placeholder="Filter books..." className="search" value={filterText} onChange={habdelchabde} id="lws-searchBook" />
        </div>
      </form>
    </div>
  </nav>
